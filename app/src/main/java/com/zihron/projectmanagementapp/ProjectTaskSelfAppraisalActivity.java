...
public class ProjectTaskSelfAppraisalActivity extends AppCompatActivity {
...
private TextView weekSelectnErrTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_task_self_appraisal);
        activity=this;
    ...
    {
        Intent pTSACIntent = new Intent(ProjectTaskSelfAppraisalActivity.this, ProjectEachAssignedTaskReviewActivity.class);
        startActivity(pTSACIntent);
    }
...
public void memberSelfAppraisal(View view)
{
    if(questCAns==null)
    {
        ...
        if(appraisalWeek==null || appraisalWeek=="")
        {
            ...
            try {
                ...
                appraisalJSONArray.put(appraisalJSONObject);
               String result = insertNewSelfAppraisal(appraisalJSONArray.toString(), appraisalWeek, userName, projectName, projectTaskName, appraisalYear);
                if (result.equalsIgnoreCase("Record Inserted")) {
                    Toast.makeText(activity, "Your record has been inserted", Toast.LENGTH_LONG).show();
                    Intent pTSAIntnet = new Intent(ProjectTaskSelfAppraisalActivity.this, ProjectEachAssignedTaskReviewActivity.class);
                    startActivity(pTSAIntnet);
                } else {
    ...
    public String insertNewSelfAppraisal(String appraisalDetailsToString,String appraisalWeek,String userName, String projectName, String projectTaskName, String appraisalYear)
    {
        String  result = null;
       ...
       String appraisalDate = new SimpleDateFormat("yyyy/MM/dd", Locale.getDefault()).format(new Date());
        try {
            ...
            httpRequestClass = new HttpRequestClass("http://naijaconnectsapis.ca/projectmanagement-1.0/projectmanagement/iiisad/",postDataParams, activity,"text/plain", "application/json");
