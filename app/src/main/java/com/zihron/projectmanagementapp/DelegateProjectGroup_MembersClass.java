...
public class DelegateProjectGroup_MembersClass {
    ...
    private DelegateProjectMembersClass delegateProjectMembersClass;
    private DelegateProjectToGroupsListClass delegateProjectToGroupsListClass;
    private SharedPreferences sharedPreferences;
    public DelegateProjectGroup_MembersClass(final TableLayout membersSelectedDelegateOuterTableLayout, RelativeLayout openClosedBottomSheet,final BottomSheetBehavior bottomSheetBehavior, RadioGroup friends_groups_RadioGroup,final Button getSelectedMembersButton,final SearchView friendGroupSearchView,final Button del_unDelMembersButton,final LinearLayout groups_members_LinearLayout,final Activity activity)
    {
        ...
        friends_groups_RadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                //   String result = getNotProjectDelegatedMembers();

                   // delegateProjectMembersClass = new DelegateProjectMembersClass(getSelectedMembersButton, friendGroupSearchView, del_unDelMembersButton, groups_members_LinearLayout,activity,membersSelectedDelegateOuterTableLayout,result,bottomSheetBehavior);
                }

                else if (checkedId == R.id.groupsRadioBtnId) {
                   //     String result = getNotProjectDelegatedGroups();
                 //   delegateProjectToGroupsListClass  = new  DelegateProjectToGroupsListClass(getSelectedMembersButton, friendGroupSearchView,del_unDelMembersButton, groups_members_LinearLayout, activity,  membersSelectedDelegateOuterTableLayout, result, bottomSheetBehavior);
    ...
    public String getNotProjectDelegatedMembers()
    {
        String  result = null;
        ...
        try {
            ...
            httpRequestClass = new HttpRequestClass("http://naijaconnectsapis.ca/projectmanagement-1.0/projectmanagement/ndpm/",postDataParams, activity,"application/json", "application/json");
