...
public class ProjectTaskSelectMembersNotAssignedClass {
 ...
 private ArrayList<String>  chatMemberArrayList;
    ...
    public ProjectTaskSelectMembersNotAssignedClass(LinearLayout selectedFriendHViewLinearLayout, Button selectedFriendsButton, final Activity activity, String result)
    {
        ...
        selectedFriendsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String  result = unAssignTaskToSelectedMembers(userName,projectTaskName,projectName,selectedMemberArrayList.toString(), groupName );
                       ...
                       public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                           try {
                               ...
                               if (isChecked) {
                                   ...
                                   notificationObject.put("userName",tempObject.getString("userName"));
                                   notificationObject.put("groupName",groupName);
                                   notificationMemberJArray.remove(notificationObject);
    ...
    public String unAssignTaskToSelectedMembers(String userName,String taskName,String projectName,String jsonList, String groupName )
