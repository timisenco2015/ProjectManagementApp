...
public class ValidateEditProjectTaskInput {

    public ValidateEditProjectTaskInput()
    {
    ...
    public String validationProjectNameField(String fieldValue)
    {
        ...
        if(fieldValue.length()>0)
        {
            for(int i=0; i<fieldValue.length() && !invalid; i++) {
                ...
                {
                    invalid = true;
                    result = "Your project name contains invalid characters";
                }
            }
        }
        ...
        {
            result = "Project name field value cannot be empty";
        }
    ...
    public String validationProjectTaskNameField(String fieldValue)
    {
        String result="field okay";
        boolean invalid = false;
        if(fieldValue.length()>0)
        {
            for(int i=0; i<fieldValue.length() && !invalid; i++) {
                ...
                {
                    invalid = true;
                    result = "Your task name contains invalid characters";
                }
            }
        }
        ...
        {
            result = "task name field value cannot be empty";
        }
