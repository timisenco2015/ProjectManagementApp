...
public class SupervisorAppraisalBySupervisor extends AppCompatActivity {
    ...
    private Spinner supervisorSelectSpinner;

    private ArrayList<String> allUserSupervisorsList;
    private ProgressBarClass progressBarClass;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_supervisor_appraisal_by_supervisor);
        ...
        supervisorSelectSpinner = (Spinner)findViewById(R.id.supervisorSelectSpinnerId);
        ...
        getAllAppraisalReviewButton.setEnabled(false);
        try {
            String result = getAllUserSupervisors();
           ...
           if(result!=null)
           {
            JSONArray tempArray = new JSONArray(result);
                ...
                googleJson = new Gson();
                allUserSupervisorsList = googleJson.fromJson(tempArray.toString(), ArrayList.class);
                allUserSupervisorsList.add(0,"--- Select ---");
               dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,  allUserSupervisorsList);
               supervisorSelectSpinner.setSelection(0,false);
               dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
               supervisorSelectSpinner.setAdapter(dataAdapter);
            }
        ...
        supervisorSelectSpinner.setSelection(0,false);
        supervisorSelectSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selectedSupervisor = parent.getItemAtPosition(position).toString();
                selectedProject="All";
                selectedProjectTask="All";
                getAllAppraisalReviewButton.setEnabled(true);
                if(!selectedSupervisor.startsWith("---")) {
    ...
    {
        try {
            String result = getAllSupervisorsAppraisedProjects();
            if(result!=null)
            {
            JSONArray tempArray = new JSONArray(result);
    ...
    public void populateProjectTaskSpinner()
    {
        ...
        try {
            String result = getAllSupervisorsAppraisedProjectsAllTask();
            if(result!=null)
            {
            JSONArray tempArray = new JSONArray(result);
    ...
    public void allSupervisorClick(View view)
    {
        ...
        RelativeLayout innerRelativeLayout = ( RelativeLayout) allSupervisorClick.getChildAt(0);
        innerRelativeLayout.setBackgroundColor(activity.getResources().getColor(R.color.color12));
    ...
    public void  navigateToApprActivity(View view)
    {
        ...
        SupervisorAppraisalBySupervisor.this.startActivity(aAIntent);
    }
    public void popUpView(String textMessage)
    {
        ...
        projectNameTextView.setTypeface(Typeface.create("lato", Typeface.NORMAL));
    ...
    public String getSupervisorAppraisalDetails()
    {
        ...
        try {
            ...
            httpRequestClass = new HttpRequestClass("http://naijaconnectsapis.ca/projectmanagement-1.0/projectmanagement/fsarbs/",postDataParams, activity,"application/json", "application/json");
    ...
    public String getAllSupervisorsAppraisedProjects()
    {
        String  result = null;
        JSONObject postDataParams = new JSONObject();
        try {
            postDataParams.put("nameOfUser", userName);
            postDataParams.put("nameOfSupervisor", selectedSupervisor);
    ...
    public String getAllUserSupervisors()
    {
        String  result = null;
        JSONObject postDataParams = new JSONObject();
        try {
    ...
    public String getAllSupervisorsAppraisedProjectsAllTask()
    {
        String  result = null;
        JSONObject postDataParams = new JSONObject();
        try {
